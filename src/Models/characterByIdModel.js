...
exports.fetchCharacterById = void 0;
var connection_1 = require("../../db/connection");
var fetchCharacterById = function (character_id) { return __awaiter(void 0, void 0, void 0, function () {
    var query, rows;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, connection_1.default.query(query, [character_id])];
            case 1:
                rows = (_a.sent()).rows;
