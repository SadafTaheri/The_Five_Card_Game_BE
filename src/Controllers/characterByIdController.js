...
var characterByIdModel_1 = require("../Models/characterByIdModel");
var getCharacterById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var character_id, characterData, charObject, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, characterByIdModel_1.fetchCharacterById)(Number(character_id))];
            case 2:
                characterData = _a.sent();
                if (!characterData) {
                    return [2 /*return*/, res.status(404).send({ message: "Character not found" })];
                }
                charObject = {
